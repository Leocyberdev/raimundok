...
import os
from models.user import db, User, Order, OrderObservation, Notification, ServiceOrder, AuditLog, FileReference # Adicionado AuditLog e FileReference
from datetime import date
import pytz
from utils.date_utils import get_delivery_status_text, get_weekday_name_pt
...
def update_status(order_id):
    ...
    from models.user import StatusHistory
