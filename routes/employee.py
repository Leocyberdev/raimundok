...
import pytz
from models.user import db, User, Order, OrderObservation, Notification, StatusHistory, DeliveryOption, StatusPermission, ServiceOrder
from utils.date_utils import get_delivery_status_text, get_weekday_name_pt, get_elapsed_days_text, is_delivery_urgent
...
def order_detail(order_id):
    ...
    from models.user import StatusHistory, DeliveryOption
...
def add_observation(order_id):
    ...
    from models.user import OrderObservation
...
def change_order_status(order_id):
    ...
    from models.user import StatusPermission, StatusHistory, DeliveryOption
...
def get_status_permissions():
    ...
    from models.user import StatusPermission
