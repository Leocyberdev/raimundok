...
class Order(db.Model):
    ...
    tracking_token = db.Column(db.String(100), unique=True, nullable=True, default=lambda: str(uuid.uuid4()))
    ...
    def get_tracking_url(self, base_url):
        """Retorna a URL de rastreamento do pedido"""
        return f"{base_url}/rastreamento/{self.tracking_token}"
